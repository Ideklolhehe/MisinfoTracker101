"""
Enhanced detector agent for the CIVILIAN multi-agent system.
Responsible for detecting misinformation in content from various sources.
"""
...
class DetectorAgent(BaseAgent):
    ...
    def __init__(self, text_processor: TextProcessor, vector_store: VectorStore):
        ...
        """
        super().__init__('detector', 300)  # 5 min refresh interval
        self.text_processor = text_processor
        self.vector_store = vector_store
        self.ai_processor = AIProcessor()
        self.detection_threshold = 0.75  # Confidence threshold for misinformation detection
        self.similarity_threshold = 0.85  # Threshold for similarity matching
